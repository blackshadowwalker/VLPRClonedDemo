...
extern "C" {
	...
	static char *ErrorInfo[15]={"授权已过期","识别缓冲区已满","模块没有合法授权","读取模块授权出错","不是合法的加密狗用户","读取加密狗用户出错","不是合法的加密狗","读取加密狗出错","车辆类型识别模块错误","没有找到加密狗","省份设置错误","没有错误"};
	static char **pErrorInfo = &ErrorInfo[11];
